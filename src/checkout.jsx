 ...
 const submit=async e=>{
  ...
  try{
   const result=await customerApi.createOrder({
    items:cart.map(item=>({productId:item.productId||item.id,variantId:item.variantId||null,quantity:Number(item.quantity)||1,configuration:item.configuration||null})),
